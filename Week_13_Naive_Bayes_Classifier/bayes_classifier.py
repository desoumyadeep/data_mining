...
home_dir = "/Users/soumyadeepde/OneDrive/Documents/Study/MS/202101 - Spring/CS_412_Coursework/Week_13_Naive_Bayes_Classifier"
...
class NaiveBayesClassifier:
    ...
    def load_data(self):
        with open(home_dir + "/dataset/input/zoo_tester.data", newline="") as f:
            for line in f:
    ...
    def print_data(self):
        for key, value in self.class_probability.items():
            print("{0}: {1}".format(key, value))

        for key, value in self.feature_proability.items():
            print("{0}: {1}".format(key, value))

        print(self.predict_data)
        # for x in self.unique_feature:
        #     print(x)
        print(self.unique_feature)
